"""
Django settings for agent_planning project.
...
SECRET_KEY = 'django-insecure-t#!e(%s$nm31t#ro!$t%=hzl-n+5#fyg@u1v+ejvn@&d&mz+b#'
...
ROOT_URLCONF = 'agent_planning.urls'
...
WSGI_APPLICATION = 'agent_planning.wsgi.application'
...
AUTH_USER_MODEL = 'planning_api.User'
